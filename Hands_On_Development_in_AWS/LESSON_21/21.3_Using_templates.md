...
![resource_and_property_reference.png](./IMAGES/21.3_Using_templates/resource_and_property_reference.png)

  - Navigated to **Resource and property reference**

![aws_s3_bucket.png](./IMAGES/21.3_Using_templates/aws_s3_bucket.png)

  - Selected **Amazon S3 → Bucket**

![bucket_name.png](./IMAGES/21.3_Using_templates/bucket_name.png)
...
![validate_template.png](./IMAGES/21.3_Using_templates/validate_template.png)
...
![create_stack_button.png](./IMAGES/21.3_Using_templates/create_stack_button.png)
...
![amazon_s3_url.png](./IMAGES/21.3_Using_templates/amazon_s3_url.png)
![details_stack_name.png](./IMAGES/21.3_Using_templates/details_stack_name.png)
![configure_stack_options.png](./IMAGES/21.3_Using_templates/configure_stack_options.png)
![create_failed.png](./IMAGES/21.3_Using_templates/create_failed.png)


- **Fixing and Redeploying**
- 
![bucket_complete.png](./IMAGES/21.3_Using_templates/bucket_complete.png)
...
![amazon_s3.png](./IMAGES/21.3_Using_templates/amazon_s3.png)
