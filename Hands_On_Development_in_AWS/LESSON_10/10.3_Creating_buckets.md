...
![boto3.png)](./IMAGES/10.3_Creating_buckets/boto3.png)

[CODE](https://github.com/progressivepull/AWS-Deep-Dives/blob/main/Hands_On_Development_in_AWS/CODE/S3/PythonS3/app.py)
...
![cmd_syc.png](./IMAGES/10.3_Creating_buckets/cmd_syc.png)

## 6. Using the `sync` Command

The AWS CLI sync command is used to synchronize the contents of one location with another.
It compares source and destination and only transfers new or changed files, making it efficient for large directories.
