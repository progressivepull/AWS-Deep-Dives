...
``` bash
$ eb init --region us-east-1 -p php
```

![cmd_init_files.png](./IMAGES/16.3_Development_stacks/cmd_init_files.png)
...
![cmd_create_php_file.png](./IMAGES/16.3_Development_stacks/cmd_create_php_file.png)
...
![cmd_create_enviroment.png](./IMAGES/16.3_Development_stacks/cmd_create_enviroment.png)
...
![view_console_testphp.png](./IMAGES/16.3_Development_stacks/view_console_testphp.png)
